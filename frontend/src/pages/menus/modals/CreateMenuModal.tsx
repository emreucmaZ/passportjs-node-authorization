...
function CreateMenuModal({ isVisible, handleClose, state,menus }: ICreateMenuModalProps) {
            ...
            <form onSubmit={formik.handleSubmit}>
              <TextField
                ...
                onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{
                  ...
                  formik.setFieldValue("route",slugify(e.currentTarget.value,{lower:true}));
                }}
              ...
              <FormControl fullWidth sx={{ marginTop: 2 }}>
                <InputLabel id="demo-simple-select-label">Üst Menü Id</InputLabel>
                <Select
